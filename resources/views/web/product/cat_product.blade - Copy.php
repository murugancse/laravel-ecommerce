...
<!--<a href="product_preview.php" style="color: black;">-->
  <div class="product_div">
    ...
    @endphp
  <center>
    <img src="<?php echo $url; ?>{{$product->product_image}}" class="product_image">
  </center>
<div style="height: 85px;">
  <p class="product_name"><img src="<?php echo $prev_url; ?>/webstyle/image/green.PNG" style="margin-right: 5px;">{{$product->product_name}}</p>
