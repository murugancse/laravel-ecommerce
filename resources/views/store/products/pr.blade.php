                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <form class="forms-sample" action="{{route('stock_update', $sel->p_id)}}" method="post" enctype="multipart/form-data">
                          ...
                          <button type="submit" style="border:none;background-color:transparent;float:left;width: 40px !important;height: 40px;border-radius: 50%;"><a class="btn btn-sm" src="{{url('images/icon/add.png')}}" alt="add">ADD </a></button>
                            </div>
                          </form>
                          </div>
                        </td>
