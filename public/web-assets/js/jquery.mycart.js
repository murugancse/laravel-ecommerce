  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '</div>' +
        '<div class="modal-body"> <div class="alert alert-danger" role="alert" id="'+idEmptyCartMessage+'">Your cart is empty</div>' +
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="Unit Price">'+ currencySymbol + this.price + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 50px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">'+ currencySymbol + total + '</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '">'+currencySymbol+'</strong></td>' +
        '<td></td>'
          : ' '
      ...
      if(!products.length){
          $("#"+idEmptyCartMessage).removeClass('hide');
      }else{
          $("#"+idEmptyCartMessage).addClass('hide');
      }
      ...
      if(discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong id="' + idDiscountPrice + '">'+currencySymbol+'</strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    var showGrandTotal = function(products){
      ...
      $("#" + idGrandTotal).text(currencySymbol + total);
      $(".total-price-basket .value").text(currencySymbol + total.toFixed(2));
    }
    var showDiscountPrice = function(products){
      $("#" + idDiscountPrice).text(currencySymbol + options.getDiscountPrice(products));
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(currencySymbol + price * quantity);
...
function showGrandTotalNew(){
    ...
    $(".total-price-basket .value").text(currencySymbol+totalCost.toFixed(2));
}
