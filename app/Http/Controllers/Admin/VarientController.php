...
class VarientController extends Controller
{
   ...
   public function AddNewproduct(Request $request)
    {
        ...
        if($request->hasFile('varient_image')){
            ...
            $image->move('public/images/product/'.$date.'/', $fileName);
            $image = 'public/images/product/'.$date.'/'.$fileName;
        }
        else{
            $image = 'N/A';
        }
    ...
    public function Updateproduct(Request $request)
   {
        ...
        if($request->hasFile('varient_image')){
            ...
            $fileName = str_replace(" ", "-", $fileName);
            $varient_image->move('public/images/product/'.$date.'/', $fileName);
            $varient_image = 'public/images/product/'.$date.'/'.$fileName;
        }
        else{
            $varient_image = $image;
        }
